...
-- data_copilot_v10_sys tables
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`session_operation_log` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `session_id` VARCHAR(255) NOT NULL COMMENT '会话ID',
  `api_endpoint` VARCHAR(255) NOT NULL COMMENT '调用的API接口',
  `question` LONGTEXT COMMENT '用户输入的问题',
...
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`observe_session_log` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `session_id` VARCHAR(255) NOT NULL COMMENT '会话ID',
  `question` LONGTEXT COMMENT '用户问题',
  `status` VARCHAR(50) COMMENT '会话状态',
...
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`observe_cycle_log` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `session_id` VARCHAR(255) NOT NULL COMMENT '会话ID',
  `cycle_index` INT NOT NULL COMMENT '循环序号',
  `phase` VARCHAR(50) NOT NULL COMMENT '阶段: think/execute/observe',
...
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`report_generation_log` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `session_id` VARCHAR(255) NOT NULL COMMENT '会话ID',
  `file_name` VARCHAR(512) COMMENT '生成的文件名',
  `chat_history` LONGTEXT COMMENT '输入的聊天历史(JSON)',
...
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`base_knowledge` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `key` TEXT NOT NULL COMMENT '基础知识键',
  `value` LONGTEXT COMMENT '基础知识值',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`db_query_guide` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `key` TEXT NOT NULL COMMENT '查询指南键',
  `value` LONGTEXT COMMENT '查询指南值',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`doc_knowledge` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `key` TEXT NOT NULL COMMENT '文档知识键',
  `value` LONGTEXT COMMENT '文档知识值',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `data_copilot_v10_sys`.`graph_code_guide` (
  `id` INT NOT NULL AUTO_INCREMENT COMMENT '主键',
  `key` TEXT NOT NULL COMMENT '图表代码指南键',
  `value` LONGTEXT COMMENT '图表代码指南值',
  PRIMARY KEY (`id`)
