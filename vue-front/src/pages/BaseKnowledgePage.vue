  ...
  <div class="knowledge-page">
    ...
    <div v-if="showForm" class="modal-overlay" @click.self="closeForm">
      <div class="modal-content">
        <h3>{{ editingItem ? 'Edit' : 'New' }} Base Knowledge</h3>
        <div class="modal-body">
          <div class="form-group">
            <label>Key</label>
            <input v-model="formKey" type="text" class="form-input" placeholder="Knowledge key" />
          </div>
          <div class="form-group">
            <label>Value</label>
            <textarea v-model="formValue" class="form-textarea" rows="6" placeholder="Knowledge content"></textarea>
          </div>
...
const API_BASE = '/api/sys-knowledge/base-knowledge'
